...
urlpatterns = [
    ...
    path('register_p/',views.patient_register),
    ...
    path(
        'save_accepted_appointment/<str:name>/<str:mobile_no>/<int:age>/<str:gender>/<str:disease>/<str:d_name>/<str:speciality>/<int:d_id>/<int:p_id>/<int:pk>',
        views.save_accepted_appointment, name='save_accepted_appointment'),
